...
public class Stepdefs {
    ...
    @When("incorred username {string} and password {string} are given")
    public void incorredUsernameAndPasswordAreGiven(String username, String password) {
        logInWith(username, password);
    }
    ...
    public void userIsNotCreatedAndErrorIsReported(String string) {
        System.out.println("^^^^^^stringgg" + string);
    ...
    @When("a valid username {string} and password {string} and nonmatching password confirmation are entered")
    public void aValidUsernameAndPasswordAndNonmatchingPasswordConfirmationAreEntered(String username, String password) {
        signUpWith(username, password, password+"t");
    }
    ...
    @When("a invalid username {string} and invalid password {string} are given")
    public void aInvalidUsernameAndInvalidPasswordAreGiven(String username, String password) {
        logInWith(username, password);
    }
